...
// после выполения данной задачи, я посмотрел реализацию в решениях
// исправлять не стал (в решении цикла for нет), но интересно, что мой вариант тоже работает
// хоть и выводит в консоль ошибку:
//
// Uncaught TypeError: Cannot read property 'name' of undefined
//  at getProductMarkup (app.js:127)
//  at showCategory (app.js:111)
//  at HTMLButtonElement.clickHandler (app.js:98)
//
// Имя товара при этом всё равно отображается на странце.

function showCategory(category) {
    const goods = products[category]
    for (let i = 0; i <= goods.length; i++) {
        productsEl.insertAdjacentHTML('beforeend', getProductMarkup(goods[i]))
    }
}
